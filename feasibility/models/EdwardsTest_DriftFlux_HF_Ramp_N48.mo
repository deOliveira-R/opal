model EdwardsTest_DriftFlux_HF_Ramp_N48
  "Edwards blowdown: 5-eq drift-flux + IAPWS + Henry-Fauske + ramped break (N=48)"
  library.Boundary.ClosedEnd closed_end;
  library.Pipes.Pipe1D_DriftFlux pipe(
    redeclare package Medium = library.Media.Water,
    N=48, L=4.096, D=0.073, f_D=0.02,
...
end EdwardsTest_DriftFlux_HF_Ramp_N48;
