model EdwardsTest_DriftFlux_HF_Ramp_RegimeHT
  "Edwards blowdown: 5-eq drift-flux + IAPWS + Henry-Fauske + ramped break + regime-dependent IAC+HTC hardcoded"
  library.Boundary.ClosedEnd closed_end;
  library.Pipes.Pipe1D_DriftFlux_RegimeHT pipe(
...
end EdwardsTest_DriftFlux_HF_Ramp_RegimeHT;
