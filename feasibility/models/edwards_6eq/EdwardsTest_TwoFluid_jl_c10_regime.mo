model EdwardsTest_TwoFluid_jl_c10_regime
  "Edwards blowdown: 6-eq two-fluid + J/L strong feedback + regime map drag (drag_model=2)"
  ...
  library.Pipes.Pipe1D_TwoFluid pipe(
    ...
    mu_l_const=2.8e-4,
    // Jones/Lahey relaxation with strong alpha feedback + regime map drag
    use_relaxation=1, tau_flash=0.025, tau_flash_n=1, tau_flash_DT_ref=40.0,
    tau_cond=0.002, C_tau_alpha=10.0, drag_model=2,
...
end EdwardsTest_TwoFluid_jl_c10_regime;
