model EdwardsTest_TwoFluid_jl_c10
  "Edwards blowdown: 6-eq two-fluid + J/L with strong alpha feedback (matches 5-eq production)"
  ...
  library.Pipes.Pipe1D_TwoFluid pipe(
    ...
    mu_l_const=2.8e-4,
    // Jones/Lahey relaxation with strong alpha feedback (matches 5-eq production)
...
end EdwardsTest_TwoFluid_jl_c10;
