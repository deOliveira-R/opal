model EdwardsTest_TwoFluid_jl_c5
  "Edwards blowdown: 6-eq two-fluid + J/L with moderate alpha feedback (C_tau_alpha=5)"
  ...
  library.Pipes.Pipe1D_TwoFluid pipe(
    ...
    mu_l_const=2.8e-4,
    // Jones/Lahey relaxation with moderate alpha feedback
    use_relaxation=1, tau_flash=0.025, tau_flash_n=1, tau_flash_DT_ref=40.0,
    tau_cond=0.005, C_tau_alpha=5.0,
...
end EdwardsTest_TwoFluid_jl_c5;
