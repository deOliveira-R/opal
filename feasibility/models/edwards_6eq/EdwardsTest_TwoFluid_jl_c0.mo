model EdwardsTest_TwoFluid_jl_c0
  "Edwards blowdown: 6-eq two-fluid + J/L only, no alpha feedback, x_ne=0.14"
  ...
  library.Pipes.Pipe1D_TwoFluid pipe(
    ...
    mu_l_const=2.8e-4,
    // Jones/Lahey relaxation with no alpha feedback
    use_relaxation=1, tau_flash=0.025, tau_flash_n=1, tau_flash_DT_ref=40.0,
    tau_cond=0.005, C_tau_alpha=0.0,
...
end EdwardsTest_TwoFluid_jl_c0;
