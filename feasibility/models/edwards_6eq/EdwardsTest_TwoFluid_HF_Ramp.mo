model EdwardsTest_TwoFluid_HF_Ramp
  "Edwards blowdown: 6-eq two-fluid + IAPWS + Henry-Fauske + ramped break + J/L + C_tau_alpha=10"
  ...
  library.Pipes.Pipe1D_TwoFluid pipe(
    ...
    mu_l_const=2.8e-4,
    // Jones/Lahey relaxation with alpha-dependent tau (matches 5-eq production)
...
end EdwardsTest_TwoFluid_HF_Ramp;
