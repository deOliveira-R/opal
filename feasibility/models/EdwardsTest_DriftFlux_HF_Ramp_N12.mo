model EdwardsTest_DriftFlux_HF_Ramp_N12
  "Edwards blowdown: 5-eq drift-flux + IAPWS + Henry-Fauske + ramped break (N=12)"
  library.Boundary.ClosedEnd closed_end;
  library.Pipes.Pipe1D_DriftFlux pipe(
    redeclare package Medium = library.Media.Water,
    N=12, L=4.096, D=0.073, f_D=0.02,
...
end EdwardsTest_DriftFlux_HF_Ramp_N12;
