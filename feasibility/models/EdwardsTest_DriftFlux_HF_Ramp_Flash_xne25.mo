model EdwardsTest_DriftFlux_HF_Ramp_Flash_xne25
  "Edwards blowdown: same as Flash but with x_ne=0.25 (wider HF regime)"
  ...
  library.Pipes.Pipe1D_DriftFlux pipe(
    ...
    C_d=0.61, x_ne=0.25, N_param=0.0, c_floor=10.0,
...
end EdwardsTest_DriftFlux_HF_Ramp_Flash_xne25;
