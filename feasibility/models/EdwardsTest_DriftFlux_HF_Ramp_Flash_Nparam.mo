model EdwardsTest_DriftFlux_HF_Ramp_Flash_Nparam
  "Edwards blowdown: Flash + N_param=0.05 (activates HF denominator correction)"
  ...
  library.Pipes.Pipe1D_DriftFlux pipe(
    ...
    C_d=0.61, x_ne=0.14, N_param=0.05, c_floor=10.0,
...
end EdwardsTest_DriftFlux_HF_Ramp_Flash_Nparam;
