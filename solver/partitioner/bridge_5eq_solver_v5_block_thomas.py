"""
bridge_5eq_solver_v5_block_thomas.py -- Variant 5: 2x2 Block Thomas algorithm.

Replaces the scalar Thomas pressure solve + explicit void update with a
simultaneous 2x2 block tridiagonal solve for (delta_p, delta_alpha) per cell.
